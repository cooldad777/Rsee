...
1. Pricing shape. Per install, fixed, dated exit is the stance. Numbers stay private until Settled.
2. The Legacy Test as a written checklist, `training/LEGACY_TEST.md`. Settled only after one real run.
3. First client shape. Sequence not decided here.
